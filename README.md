...
While the advancement of transportation industry in the last hundred years enabled more travelling options to the people, it wasn't until just half a decade ago, with the emergence of social media platforms, shared economy and GPS equipped mobile devices, that these digital footprints of human mobility became public in a real-time. In this new world of shared economy, travelling cost per person has reduced due to which more and more people are moving from one region to another leaving behind their digital trails on social media sites. Although it is still not clear how living online will affect us in future, we can be sure for one thing - the huge digital
data produced by people all around the world represents almost an inexhaustible resource that can be used in different scientific studies.
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_001.jpg)
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_002.jpg)
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_003.png)
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_004.png)
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_005.png)

Digital Sketches:

![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_006.png)
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_007.png)
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_008.png)
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_009.png)
...
![alt text](https://github.com/antujn/YFCC-USA-Town-Recommendation/blob/master/docs/documentation/Readme/Image_010.png)
